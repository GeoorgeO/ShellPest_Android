    ...
    private void insertWebCosecha(String Fecha ,String Id_Bloque,String c_Codigo_eps,String BICO,String Cajas_Cosecha,String Cajas_Desecho,String Cajas_Pepena,String Cajas_RDiaria ,String Id_Usuario_Crea ,String F_Usuario_Crea) {
        ...
        if(MyIp.equals("0.0.0.0")){
            ...
            if (MyIp.indexOf("192.168.3")>=0 || MyIp.indexOf("192.168.68")>=0 ||  MyIp.indexOf("10.0.2")>=0 ){
                Liga = Clase.IpLocal+Clase.PortLocal+"//Control/Cosecha?Fecha=" + ano + "" + mes + "" + dia  + "&Id_Bloque=" + Id_Bloque +"&c_codigo_eps="+c_Codigo_eps +"&BICO=" + BICO + "&Cajas_Cosecha=" + Cajas_Cosecha + "&Cajas_Desecho=" + Cajas_Desecho + "&Cajas_Pepena=" + Cajas_Pepena + "&Cajas_RDiaria=" + Cajas_RDiaria+ "&Id_Usuario=" + Id_Usuario_Crea + "&F_Fecha_Crea=" + ano2 + "" + mes2 + "" + dia2;
            }else{
                Liga = Clase.IpoDNS+Clase.Puerto+"//Control/Cosecha?Fecha=" + ano + "" + mes + "" + dia  + "&Id_Bloque=" + Id_Bloque +"&c_codigo_eps="+c_Codigo_eps +"&BICO=" + BICO + "&Cajas_Cosecha=" + Cajas_Cosecha + "&Cajas_Desecho=" + Cajas_Desecho + "&Cajas_Pepena=" + Cajas_Pepena + "&Cajas_RDiaria=" + Cajas_RDiaria+ "&Id_Usuario=" + Id_Usuario_Crea + "&F_Fecha_Crea=" + ano2 + "" + mes2 + "" + dia2;
            }
        }
